...
const EmployeeDetails = () => {
  ...
  const handleAddFavorite = () => {
    if (!isEmployeeInFavorite) {
      ...
      toast.success('This item is Successfully added to Favorites!')
    }
  };
    ...
    <div className="max-w-xl mx-auto py-20">
      {employee && (
        <div className='shadow-lg rounded-lg p-4 relative'>
          ...
          {coordinates ? (
            <div className="mt-4">
              <MapContainer center={[coordinates.latitude, coordinates.longitude]} zoom={10} style={{ height: "300px", width: "100%" }}>
                <TileLayer
